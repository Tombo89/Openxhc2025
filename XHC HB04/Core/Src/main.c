...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Rot_A_Pin Rot_S_Pin Rot_F_Pin ENC_B_Pin */
  GPIO_InitStruct.Pin = Rot_A_Pin|Rot_S_Pin|Rot_F_Pin|ENC_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : Rot_X_Pin Rot_Y_Pin Rot_Z_Pin ENC_A_Pin */
  GPIO_InitStruct.Pin = Rot_X_Pin|Rot_Y_Pin|Rot_Z_Pin|ENC_A_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
